...
excerpt: "Era of Chaos Ehrenansturm. Ehrenansturm. Era of Chaos Exklusiv Ehrenansturm. Vampir Exklusiv."
last_modified_at: 2021-03-02
locale: de
ref: "Vampire Ehrenansturm.md"
toc: false
classes: wide
---
 ...
 **Exklusiv for Unit:** [Vampir](/units/Vampire/) 
...
## Rangaufstieg
  ...
  | **4x** <i class="fas fa-star"/> | ? | Erhöht den SCHD (Einheit) des Vampirs um 20 %. |
  | **5x** <i class="fas fa-star"/> | ? | Erhöht den Krit. Treffer um 200 und Krit. Gesamt-SCHD um 20 %, wenn Gegner mit Niedriger Moral angegriffen werden. |
  | **6x** <i class="fas fa-star"/> | ? | <Blutdurchtränkte Rüstung> Vampir-Einheiten gewähren sich selbst einen Schild in Höhe von 5 % ihrer max. LP, wenn ein Vampir stirbt. Immer wenn diese Fähigkeit ausgelöst wird, erhöht sich ihr Schild von diesem Basiswert aus um 5 % – bis zu 45 % ihrer max. LP. Jeder Schild hält nach dem Auslösen 5 Sek. lang an. |
