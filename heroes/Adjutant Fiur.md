...
## Extra bonus
  ...
  | **20** | <Ruinierte Intelligenz> Verringert die Intelligenz gegnerischer Helden zusätzlich um 40 Punkte. | - |
  | **30** | Erhöht das Wissen des verbündeten Helden um 40 (alle Helden). | **+1500** |
  | **40** | <Ruinierte Intelligenz> Verringert den Zauber-SCHD gegnerischer Helden um 30 %. | - |
