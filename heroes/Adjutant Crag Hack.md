...
## Extra bonus
  ...
  | **20** | <Bis zum Tod> Erhöht die Durchdringung zusätzlich um 50 Punkte. | - |
  | **30** | Erhöht die ABW des verbündeten Helden um 40 (alle Helden). | **+1500** |
  | **40** | <Bis zum Tod> Erhöht den SCHD (Einheit) von Nahkampfeinheiten um 10 %, wenn sie gegen blutende Gegner kämpfen. | - |
