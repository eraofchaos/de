...
## Extra bonus
  ...
  | **20** | <Verbesserter Dungeon> Erhöht die Zähigkeit zusätzlich um 100. | - |
  | **30** | Erhöht den ANG des verbündeten Helden um 40 (alle Helden). | **+1500** |
  | **40** | <Verbesserter Dungeon> Jedes Mal, wenn eine Einheit der Dungeon-Fraktion eingesetzt wird, wird das Anfangsmana verbündeter Helden um 3 erhöht und das Anfangsmana gegnerischer Helden um 3 verringert. | - |
