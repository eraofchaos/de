...
## Extra bonus
  ...
  | **20** | <Feuriger Amoklauf> Erhöht den Effekt von Feuerzaubern um zusätzliche 5 %. | - |
  | **30** | Erhöht den ANG des verbündeten Helden um 40 (alle Helden). | **+1500** |
  | **40** | <Feuriger Amoklauf> Erhöht die Feuer-Magieresistenz verbündeter Einheiten um zusätzliche 20 %. Erhöht Krit. Treffer von Efreets um zusätzliche 20 %. | - |
