...
## Extra bonus
  ...
  | **20** | <Verbessertes Schloss> Erhöht das Angriffstempo um zusätzliche 5 %. | - |
  | **30** | Erhöht den ANG des verbündeten Helden um 40 (alle Helden). | **+1500** |
  | **40** | <Verbessertes Schloss> Erhöht die SCHD-Reduzierung (Einheit) von Abwehr-Einheiten um zusätzliche 10 %. Dieser Effekt wird für Kreuzritter verdoppelt. | - |
