...
## Extra bonus
  ...
  | **20** | <Fürchterliche Aura> Erhöht den SCHD (Einheit) um zusätzliche 5 %. | - |
  | **30** | Erhöht die ABW des verbündeten Helden um 60 (alle Helden). | **+1500** |
  | **40** | <Fürchterliche Aura> Erhöht die SCHD-Reduzierung (Einheit) von Nahkampfeinheiten um zusätzliche 10 %. Dieser Effekt wird für Schwarze Ritter verdoppelt. | - |
